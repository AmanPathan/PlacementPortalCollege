        ...
        <div className="dashboard_top">
          <div className="search_bar_div">
            <input
              ...
              value={q}
              type="text"
              placeholder="Seach Companies, Students, or Skills ..."
            />
                  ...
                  return (
                    ...
                    <a href={`/students/${ID}`} className="card" key={i}>
                      ...
                      <div className="card-details">
                        ...
                        <p className="card_company_role">
                          <span className="card_span">Role:</span>{" "}
                          {item.Jobprofile}
                        </p>
                        <p className="card_student_skills">
                          <span className="card_span">Package:</span>{" "}
                          {item.Package} LPA
                        </p>
                      </div>
                    </a>
